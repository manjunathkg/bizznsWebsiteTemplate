...
jQuery(document).ready(function() {
	...
	default_settings = {
		color: '#2773ae',
		pattern: 'pattern_11', 			/* 'pattern_0', 'pattern_1' ... 'pattern_15' or 'none'  -  you can use if layout isn't  'full-width' */
...
function getThemeSettings(){
	...
	if(themeSettings.bg && themeSettings.bg != 'none' && themeSettings.bg != 'js/style-switcher/images/none.jpg' && themeSettings.layout != 'full-width'){
		jQuery('body').css('background-image', 'url('+ directory + themeSettings.bg +')').removeClass('background-pattern').addClass('background-cover');
	} else if(themeSettings.pattern && themeSettings.pattern != 'none' && themeSettings.pattern != 'js/style-switcher/patterns/none.png' && themeSettings.layout != 'full-width'){
